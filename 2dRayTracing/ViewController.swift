...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        drawableView = DrawableView(boundaryColor: .gray, lightColor: .yellow, lineWidth: 2, lightWidth: 5, frame: CGRect(origin: .zero, size: CGSize(width: view.bounds.width, height: view.bounds.height - 190)))
